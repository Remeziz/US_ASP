...
-- depends_on: {{ ref('na_get_fba_fulfillmen_1_replacement_data_ab2') }}
select
    ...
    ]) }} as _airbyte_na_get_fba_f__placement_data_hashid,
    tmp.*
from {{ ref('na_get_fba_fulfillmen_1_replacement_data_ab2') }} tmp
