...
-- depends_on: {{ ref('us_get_fba_fulfillmen_1_replacement_data_ab2') }}
select
    ...
    ]) }} as _airbyte_us_get_fba_f__placement_data_hashid,
    tmp.*
from {{ ref('us_get_fba_fulfillmen_1_replacement_data_ab2') }} tmp
